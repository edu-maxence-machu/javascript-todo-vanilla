...
var token = localStorage.getItem('usr_token') || null;
...
(async function() {
  ...
  todos.map((el) => {
    el.completed === false ? data.todo.push(el) : data.completed.push(el);
  })
...
let box_login = document.getElementById('login');
let box_register = document.getElementById('register');
